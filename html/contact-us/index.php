...
<body>
    ...
    <section class="navfixed-top">
        <nav class=" navbar container navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="<?php echo DOMAIN_ORIGIN; ?>"><img src="../images/banner_logo.svg" width="150px" alt=""></a>
    ...
    <section class="details_container container my-5">
        ...
        <div class="shadow p-3 mb-5 bg-white rounded">
            ...
            <form action="">
                <div class="row">
                    <div class="input_my_style contact-us col-md-6">
                ...
                <div class="row">
                    ...
                    <div id="pre_opt_container" class="col-md-6 input_my_style selection">
                        <select name="" id="">
                            <option value="" selected="true" disabled="disabled">--Select Issue--</option>
                ...
                <p class="my_text"><b>Supported Languages:</b> <?php echo SUPPORTED_LANGUAGES; ?></p>
                <div class="row">
                    <div class="input_my_style contact-us col-sm-12">
                        <textarea name="" id="" rows="4" placeholder=" "></textarea>
                        <label for="">Enter your email</label>
